...
class Movenet(object):
  ...
  def __init__(self, model_name: str) -> None:
    ...
    # Initialize model Edge TPU
    #interpreter = tflite.Interpreter(model_path=model_name,experimental_delegates=[tflite.load_delegate('edgetpu.dll')])
